...
const ResultsSummary = () => {
  return (
    <main className="flex justify-center  items-center h-screen font-hankenGrotesk">
      <div className="flex flex-col rounded-3xl w-full shadow-xl overflow-hidden sm:flex-row sm:w-[620px]">
        <div className="flex flex-col gap-5 items-center w-full bg-gradient-to-b from-lightSlateBlue to-lightRoyalBlue rounded-3xl pt-14 pb-10  pl-10 pr-10 sm:w-1/2 sm:pt-6">
          <span className="text-lg text-lightLavender">Your Result</span>
          <div className="flex flex-col justify-center items-center text-white  w-32 h-32 bg-gradient-to-b from-violetBlue to-persianBlue rounded-full p-10 sm:w-40 sm:h-40">
